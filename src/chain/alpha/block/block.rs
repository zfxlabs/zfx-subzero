...
pub fn genesis_vrf_out() -> [u8; 32] {
    ...
    let vrf_out_v =
        hex::decode("57e1e774e97685b9dc2dbcb7a327fa96a60dcda0919ad1b75877885bd219bfc4").unwrap();
    for i in 0..32 {
...
pub fn genesis(initial_stakers: Vec<InitialStaker>) -> Block {
    ...
    Block { predecessor: None, height: 0u64, vrf_out: genesis_vrf_out(), txs }
}
...
impl Block {
    pub fn new(
        ...
        Block { predecessor: Some(predecessor), height, vrf_out, txs }
    }
