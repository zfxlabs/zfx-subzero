...
impl Transaction {
    ...
    pub fn coinbase(owner: PublicKeyHash, value: Amount) -> Transaction {
	Transaction::new(vec![], vec![Output::new(owner, value)])
    }

    pub fn spend(&self, keypair: Keypair, destination: PublicKeyHash, change: PublicKeyHash, value: Amount) -> Result<Transaction> {
